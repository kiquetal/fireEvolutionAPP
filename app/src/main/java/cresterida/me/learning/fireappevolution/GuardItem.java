 ...
 */
public class GuardItem extends AbstractItem<GuardItem.ChildViewHolder>
        implements ISectionable<GuardItem.ChildViewHolder, IHeader>, IFilterable {
    ...
    public boolean shouldNotifyChange(IFlexible newItem) {
        GuardItem guardItem = (GuardItem) newItem;
        return !title.equals(guardItem.getTitle()); // Should be bound again if title is different
    }
    ...
    public String toString() {
        return "GuardItem[" + super.toString() + "]";
    }
